...
def main():
    ...
    # forced_drop = INELIGIBLE (3-consecutive-years cap; user-confirmed on
    # Jordan Love, years_kept=3) — never test those sets. Only carryover
    # and alternate candidates are legal keeps.
